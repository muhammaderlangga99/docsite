...
<div class="flex items-center justify-between mb-6">
    <div>
        <p class="text-xs uppercase tracking-[0.08em] text-slate-500 mb-1">ERICA</p>
        <h1 class="text-2xl font-semibold text-slate-900">CARLA</h1>
...
<div class="border border-slate-200 bg-white text-slate-900 rounded-xl p-6 text-sm shadow-sm space-y-4">
    ...
    <div class="grid md:grid-cols-2 gap-3">
        ...
        <div class="border border-slate-200 rounded-lg p-3 bg-slate-50/70">
            <p class="text-xs uppercase text-slate-500 tracking-[0.08em] mb-1">Baudrate</p>
            <div class="flex items-center justify-between gap-2">
                <span class="font-semibold text-slate-900 break-all">{{ $baudrate }}</span>
                <button type="button" class="text-xs px-2 py-1 rounded border border-slate-200 text-slate-600 hover:bg-slate-100 copy-btn" data-copy="{{ $baudrate }}">Copy</button>
            </div>
        </div>
    </div>
</div>
